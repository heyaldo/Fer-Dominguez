...
;(function ($, window, document, undefined) {
    ...
    // Default options
    var defaults = {
            cart: [ { product_desc: "Lorem Ipsum industry.", product_id: "155", product_image: "", product_name: "Product 5",
            product_price: "3410.00", product_size: "S"}], // initial products on cart
            ...
            lang: {  // Language variables
                cartTitle: "Noulube Carritos",
                checkout: 'Enviar PayPal',
                clear: 'Cancel',
                subtotal: 'Subtotales:',
                cartRemove:'×',
...
// PRIVATE FUNCTIONS
        ...
        _setElements: function () {
            ...
            this.cart_element.append('<div class="panel-heading sc-cart-heading" style="display: none;">' + this.options.lang.cartTitle + ' <span class="sc-cart-count badge">0</span></div>');
            this.cart_element.append('<div class="list-group sc-cart-item-list" style="display: none;"></div>');
        },
        /* 
        ...
        _setToolbar: function () {
            ...
            var toolbarSummaryPanel = $('<div class="sc-cart-summary" style="display: none;">');
            ...
            if(this.options.toolbarSettings.showClearButton){
                var btnClear = $('<button class="btn btn-danger sc-cart-clear" type="button" style="display: none;">').text(this.options.lang.clear);
        ...
        _setEvents: function () {
            ...
            // Cart checkout event
            $(this.cart_element).on( "click", '.sc-cart-checkout1', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCart1();
            });

            $(this.cart_element).on( "click", '.sc-cart-checkout2', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCart2();
            });

            $(this.cart_element).on( "click", '.sc-cart-checkout3', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCart3();
            });

            $(this.cart_element).on( "click", '.sc-cart-checkout4', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCart4();
            });

            $(this.cart_element).on( "click", '.sc-cart-checkout5', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCart5();
            });

            $(this.cart_element).on( "click", '.sc-cart-checkout6', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCart6();
            });

            $(this.cart_element).on( "click", '.sc-cart-checkout8', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCart8();
            });

            $(this.cart_element).on( "click", '.sc-cart-checkoutextra', function(e) {
                if($(this).hasClass('disabled')) { return false; }
                e.preventDefault();
                mi._submitCartExtra();
            });
        ...
        _submitCart1: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="001" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="001" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="2900" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
                               .append('<input name="cancel_return" value="http://www.yourdomain.com/yourcancelurl" type="hidden">')
                               .append('<input name="cmd" value="_cart" type="hidden">')
                               .append('<input name="upload" value="1" type="hidden">');
                    });
        ...
        _submitCart2: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="002" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="002" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="800.00" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
        ...
        _submitCart3: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="003" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="003" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="6000.00" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
        ...
        _submitCart4: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="004" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="004" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="300.00" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
        ...
        _submitCart5: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="005" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="005" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="3800.00" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
        ...
        _submitCart6: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="006" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="006" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="2500.00" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
        ...
        _submitCart8: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="008" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="008" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="1500.00" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
        ...
        _submitCartExtra: function () {
            ...
            switch(this.options.submitSettings.submitType){
                case 'paypal':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        var itemNumber = i + 1;
                        formElm.append('<input class="sc-paypal-input" name="item_number_' + itemNumber + '" value="009" type="hidden">')
                               .append('<input class="sc-paypal-input" name="item_name_' + itemNumber + '" value="009" type="hidden">')
                               .append('<input class="sc-paypal-input" name="amount_' + itemNumber + '" value="3900.00" type="hidden">')
                               .append('<input class="sc-paypal-input" name="quantity_' + itemNumber + '" value="1" type="hidden">')
                               .append('<input name="business" value="info@ferdominguez.com" type="hidden">')
                               .append('<input name="currency_code" value="MXN" type="hidden">')
                               .append('<input name="return" value="http://www.yourdomain.com/yoursuccessurl" type="hidden">')
